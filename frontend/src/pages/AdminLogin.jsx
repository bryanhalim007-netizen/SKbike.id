...
export default function AdminLogin() {
  ...
  return (
    <div className="relative min-h-screen grid-texture bg-[#0A0D14] flex items-center justify-center p-5">
      <Link
        to="/"
        data-testid="login-close-btn"
        title="Kembali ke Toko"
        className="fixed top-5 right-5 z-20 flex items-center gap-2 rounded-full border border-slate-700 bg-[#111723] px-4 py-2.5 text-sm font-semibold text-slate-200 shadow-lg hover:border-[#FF2E2E] hover:text-[#FF2E2E] transition-colors"
      >
        <X className="h-5 w-5" />
